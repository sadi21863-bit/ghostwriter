...
- Audio lipsync: ChapterEditor shows lipsync section after audio generation — character portrait selection, calls `/api/audio/lipsync`, manual status polling, "Play Lipsync Video ↗" on completion
