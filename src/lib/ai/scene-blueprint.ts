...
EXIT: <the kind of beat to end on — a decision, a charged image, or an unanswered question>`,
    ...
    return `SCENE BLUEPRINT — write the scene to fulfill this. Do NOT print these labels or list them in the prose; embed them dramatically. Vary paragraph length; do NOT overuse one-sentence paragraphs.\n${text}`;
  } catch {
    return "";
  }
}
