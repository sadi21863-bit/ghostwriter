...
export const MODE_REGISTRY = {
  ...
  combat:        { label: "Combat",        modelTier: "quality", gate: "story_modes_advanced",  qualityCheck: true,  visibility: "story_only",         realismDomains: ["combat", "body", "injury"], slash: "/fight", keywords: ["fight", "battle", "combat", "attack", "punch", "sword", "gun", "strike"], contextPolicy: { ...FULL, needsMemories: false, needsPlotThreads: false, needsRealism: true }, minDensity: "full" , role: "writer", stage: "write" },
  ...
  horror:        { label: "Horror",        modelTier: "quality", gate: "story_modes_advanced",  qualityCheck: true,  visibility: "story_only",         realismDomains: ["body", "injury"], slash: "/horror", keywords: ["horror", "terror", "monster", "scream", "creature", "dread"], contextPolicy: { ...FULL, needsMemories: false, needsPlotThreads: false, needsRealism: true } , role: "writer", stage: "write" },
  ...
  action:        { label: "Action",        modelTier: "quality", gate: "story_modes_advanced",  qualityCheck: true,  visibility: "story_and_creator",  realismDomains: ["chase", "body"], slash: "/action", keywords: ["chase", "escape", "run", "pursuit", "race against"], contextPolicy: { ...FULL, needsMemories: false, needsPlotThreads: false, needsRealism: true } , role: "writer", stage: "write" },
